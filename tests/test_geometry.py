...
from phase_engine.dsp.array_geometry import AntennaArray, calculate_bearing
from phase_engine.engine import PhaseCombiner
...
def test_antenna_array_initialization():
    positions = {"center": (0.0, 0.0, 0.0), "north": (0.0, 10.0, 0.0), "east": (10.0, 0.0, 0.0)}
